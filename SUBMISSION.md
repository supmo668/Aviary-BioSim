...
| Tests green across the loop | **277** |
...
uv run --with pytest --with pyyaml --with fhaviary --with openai --with weave \
  pytest science/tests -q                                   # 160 passed
